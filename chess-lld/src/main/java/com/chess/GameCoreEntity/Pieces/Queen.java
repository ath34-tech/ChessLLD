...
public class Queen extends Piece {
    ...
    public Queen(Color color, Player owner, Cell cell) {
    ...
    public List<Move> getLegalMoves(Board board) {
        ...
        MovementScanner.scanDirection(board, this, moves, 1, 0);
        MovementScanner.scanDirection(board, this, moves, -1, 0);
        MovementScanner.scanDirection(board, this, moves, 0, 1);
        MovementScanner.scanDirection(board, this, moves, 0, -1);

        MovementScanner.scanDirection(board, this, moves, 1, 1);
        MovementScanner.scanDirection(board, this, moves, 1, -1);
        MovementScanner.scanDirection(board, this, moves, -1, 1);
        MovementScanner.scanDirection(board, this, moves, -1, -1);
